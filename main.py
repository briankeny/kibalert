...
def argument_handler():
    ...
    parser.add_argument("-l", "--latency", type=int, default=os.getenv('LATENCY_THRESHOLD',5000), help='Check for a given latency value in ms')
    parser.add_argument("-c", "--cpu", type=int, default=os.getenv('CPU_THRESHOLD',100) , help='Check for a given CPU % threshold value ie 80')
